# Google Ads Performance Max Assets
## Southern California Well Service

### Headlines (15 short, 5 long)
...
14. Well Drilling Experts
15. San Diego Well Service
...
### Image Requirements for Performance Max

**Landscape (1.91:1) - Required**
- 1200 x 628 px (minimum 600 x 314)
- Suggested: Drill rig in action, team photo, completed well

**Square (1:1) - Required**
- 1200 x 1200 px (minimum 300 x 300)
- Suggested: Logo, pump equipment, service truck

**Portrait (4:5) - Optional but recommended**
- 960 x 1200 px (minimum 480 x 600)
- Suggested: Before/after, team member, equipment close-up

**Logo - Required**
- Square: 1200 x 1200 px (minimum 128 x 128)
- Landscape: 1200 x 300 px (minimum 512 x 128)

---

### Audience Signals (Suggested)

**Custom Segments:**
- People searching for: well drilling, pump repair, water well service, no water, well pump not working
- People who visited: competitor websites, home improvement sites
...
- All days, all hours (for emergency searches)
- Bid adjustment +20% for 6am-9am and 5pm-8pm (peak call times)

---

## Upload Instructions

1. Go to Google Ads → Campaigns → Your Performance Max Campaign
2. Click "Asset groups" in the left menu
3. Click on your asset group (or create new)
4. Add the headlines, descriptions above
5. Upload images (need to create/gather these)
6. Add logo
7. Save and let Google optimize

The more assets you provide, the better Google can optimize delivery.
